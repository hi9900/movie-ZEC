...
# admin.site.register(Genre, PostAdmin)
# admin.site.register(Actor, PostAdmin)
# admin.site.register(Director, PostAdmin)
# admin.site.register(Keyword, PostAdmin)
# admin.site.register(Review, PostAdmin)
# admin.site.register(Tag, PostAdmin)
# admin.site.register(MovieList, PostAdmin)